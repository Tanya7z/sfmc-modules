...
/** Command.register 仅声明单参回调；带 ctx 的实现需强制对齐该签名 */
type CommandRegisterCallback = (player: Player | undefined) => unknown;
