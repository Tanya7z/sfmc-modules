...
import { Msg, Permission, pointInArea_2D } from "@sfmc-bds/sdk/sapi/runtime";
import { config } from "@sfmc-bds/sdk/sapi/config";
import type { ModuleLifecycle } from "@sfmc-bds/sdk/module-loader";
...
/** 设置连锁开关(供 AdminGUI 等运行时开关 creative/survival) */
export function setCreativeChainEnabled(enabled: boolean): void {
