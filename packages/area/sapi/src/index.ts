/**
 * @sfmc-bds/module-area — v2 入口(五合一区域模块)
 *
 * 聚合 peace / fly / survival / creative / clean 五个子生命周期。
 * 配置:configs/area.json 的 areas[].features.<name>;数据由 area-service 提供。
 */

import { ModuleRegistry, type ModuleLifecycle } from "@sfmc-bds/sdk/module-loader";
...
export { isCreativeChainEnabled, setCreativeChainEnabled } from "./lifecycles/creative.js";
